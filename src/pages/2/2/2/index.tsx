            ...
            <Link href={"/2/2"}>
                ...
                <div className="text-[#527853] text-lg text-right"dir="rtl">
                    ...
                    <ul className="text-[#527853]" style={{ listStyleType: 'arabic-indic' }}>
                        <li>
                             استبسل الأبطار <span className="underline text-orange-500 group cursor-pointer relative">
                                 دافعًا  
                        ...
                        <li>زيد مسرع  <span className="underline text-orange-500 relative group cursor-pointer">جوفًا
                        <div className=" whitespace-nowrap white  opacity-0 w-auto overflow-visible bg-[#dae0da] text-lg shadow-2xl text-center rounded-lg py-2 absolute z-10 group-hover:opacity-100 bottom-full ml-14 px-3 pointer-events-none">
                        مفعول لأجله منصوب بالفتحة الظاهرة في آخره .   
                                </div>
                        </span> من الكلب</li>
                        ...
                        <li>يجتهد زيد <span className="underline text-orange-500 group relative cursor-pointer">طلبَ<div className=" whitespace-nowrap white  opacity-0 w-auto overflow-visible bg-[#dae0da] text-lg shadow-2xl text-center rounded-lg py-2 absolute z-10 group-hover:opacity-100 bottom-full ml-14 px-3 pointer-events-none">
