    ...
    return(
        <div className="lg:w-[700px]">
            <Link href={"/2/2/8"}>
                ...
                <h1 className="text-7xl">خبر كان مفرد</h1>
                <br></br>
                <p className="text-[#527853] text-lg">يكون الخبر هنا كلمة واحدة، وتكون هذه الكلمة إمّا مفردًا أو مثنى أو جمعًا</p>
                <br />
                <div className="text-[#527853] text-lg"dir="rtl">
                    <h1 className="text-2xl">الإعراب:</h1>
                    <p>خبر كان منصوب دائمُا وعلاماته:</p>
                ...
                <div className="text-[#527853] text-lg text-right"dir="rtl">
                    ...
                    <ul className="text-[#527853]" style={{ listStyleType: 'arabic-indic' }}>
                        <li>
                            كان الطقس في الليل <span className="underline text-orange-500 group cursor-pointer relative">
                                 باردًا  
                                ...
                                خبر كان منصوب بالفتحة الظاهرة في آخره  
                                </div>
                                </span>
                             </li>
                             <li>
                            كانت الطفلتان  <span className="underline text-orange-500 group cursor-pointer relative">
                                 سعيدتين  
                                <div className=" whitespace-nowrap white  opacity-0 w-auto overflow-visible bg-[#dae0da] text-lg shadow-2xl text-center rounded-lg py-2 absolute z-10 group-hover:opacity-100 bottom-full ml-14 px-3 pointer-events-none">
                                خبر كان منصوب بالياء لأنها مثنى  
                                </div>
                                </span> مخلص
                             </li>
                             <li>
                             كان الأولاد <span className="underline text-orange-500 group cursor-pointer relative">
                                 نشيطين  
                                <div className=" whitespace-nowrap white  opacity-0 w-auto overflow-visible bg-[#dae0da] text-lg shadow-2xl text-center rounded-lg py-2 absolute z-10 group-hover:opacity-100 bottom-full ml-14 px-3 pointer-events-none">
                                خبر كان منصوب بالياء لأنه جمع مذكر سالم  
                                </div>
                                </span>
                             </li>
