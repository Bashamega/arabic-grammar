    ...
    return(
        <div className="lg:w-[700px]">
            <Link href={"/2/1/2"}>
                ...
                <h1 className="text-7xl">خبر مفرد</h1>
                <br></br>
                <p className="text-[#527853] text-lg">يراد بالخبر المفرد ما ليس بجملة أو شبه جملة، وفيما يتعلق بحكم هذا الخبر بالإضافة إلى رفعه، أنه يتطابق مع المبتدأ في التذكير والتأنيث والإفراد والتثنية والجمع
                </p>
                <br />
                <div className="text-[#527853] text-lg"dir="rtl">
                    <h1 className="text-2xl">الإعراب:</h1>
                    <p>الخبر مرفوع دائمُا وعلاماته:</p>
                ...
                <div className="text-[#527853] text-lg text-right"dir="rtl">
                    ...
                    <li className="list-item-with-space"> الكتاب <span className="underline text-orange-500 group cursor-pointer relative ">
                            شيق
                        ...
                        <li>البناتُ <span className="underline text-orange-500 relative group cursor-pointer">متفوقات
                        <div className=" whitespace-nowrap white  opacity-0 w-auto overflow-visible bg-[#dae0da] text-lg shadow-2xl text-center rounded-lg py-2 absolute z-10 group-hover:opacity-100 bottom-full ml-14 px-3 pointer-events-none">
                                    خبر مرفوع وعلامة رفعه الضمة لأنها جمع مؤنث سالم
                                </div>
                        </span> </li>
                        <li>الأطفالُ<span className="underline text-orange-500 relative group cursor-pointer"> متحدثون<div className=" whitespace-nowrap white  opacity-0 w-auto overflow-visible bg-[#dae0da] text-lg shadow-2xl text-center rounded-lg py-2 absolute z-10 group-hover:opacity-100 bottom-full ml-14 px-3 pointer-events-none">
                                    خبر مرفوع وعلامة رفعه الواو لأنها جمع مذكر سالم
                                </div></span> </li>
